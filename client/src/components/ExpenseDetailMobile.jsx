    ...
    <div className="w-full h-full flex justify-center items-center">
      <div className="bg-[#2B363C] p-4 rounded-md w-[90%] h-[90%] lg:w-[750px] lg:text-2xl flex flex-col gap-[60px] justify-center items-center relative">
        ...
        <div className="flex flex-col  h-full gap-16">
          <div className="text-white flex font-semibold  font-mono text-2xl ">
          ...
          <div className="text-white flex font-semibold  font-mono text-2xl">
            <p className="w-[190px]">Description:</p><p className="flex-1 text-left ">Costco</p>
          </div>
          <div className="text-white flex font-semibold  font-mono text-2xl">
        ...
        <div className="w-full text-right mb-2 mr-2">
          <Link to="/update-expense">
            <button className="font-mono rounded-md bg-[#D9D9D9] font-semibold px-2 py-1 ">edit</button>
          </Link>
        </div>
      </div>
    </div>
