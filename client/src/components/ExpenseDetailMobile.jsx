...
const ExpenseDetailMobile = () => {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center">
      <div className="bg-[#2B363C] p-4 rounded-md w-[90%] h-[90%] lg:w-[750px] lg:text-2xl flex flex-col gap-[60px] justify-center items-center relative caret-transparent">
        ...
        <div className="flex flex-col  h-full gap-16">
          <div className="text-white flex font-semibold  font-mono ">
            <p className="w-[190px] " >Date:</p><p className="flex-1 text-left">{date}</p>
          </div>
          <div className="text-white flex font-semibold  font-mono ">
            <p className="w-[190px]" >Category:</p><p className="flex-1 text-left">{category}</p>
          </div>
          <div className="text-white flex font-semibold font-mono">
            <p className="w-[190px]" >Amount:</p><p className="flex-1 text-left">${amount}</p>
          </div>
          <div className="text-white flex font-semibold  font-mono ">
          ...
          <div className="text-white flex font-semibold  font-mono">
            <p className="w-[190px]">Note:</p><p className="flex-1 text-left text-wrap">{note ? note : "None"}</p>
          </div>
        </div>
