...
const ExpenseDetailMobile = () => {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center">
      <div className="bg-[#2B363C] p-4 rounded-md w-[90%] h-[90%] lg:w-[750px] lg:text-2xl flex flex-col gap-[60px] justify-center items-center relative caret-transparent md:text-[2.8vw] md:pt-20">
